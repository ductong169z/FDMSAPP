...
namespace FMSAPP {
    ...
    public partial class animeDataSet1 : global::System.Data.DataSet {
        ...
        public partial class roleDataTable : global::System.Data.TypedTableBase<roleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public roleRow AddroleRow(int RoleID, string slug, string name) {
        ...
        public partial class roleRow : global::System.Data.DataRow {
            ...
            public string slug {
                get {
                    try {
                        return ((string)(this[this.tablerole.slugColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'slug\' in table \'role\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablerole.slugColumn] = value;
                }
            }
            ...
            public bool IsslugNull() {
                return this.IsNull(this.tablerole.slugColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetslugNull() {
                this[this.tablerole.slugColumn] = global::System.Convert.DBNull;
            }
...
namespace FMSAPP.animeDataSet1TableAdapters {
    ...
    public partial class roleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `role` WHERE ((`RoleID` = @p1) AND ((@p2 = 1 AND `slug` IS NULL) OR (" +
                "`slug` = @p3)) AND ((@p4 = 1 AND `name` IS NULL) OR (`name` = @p5)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `role` (`RoleID`, `slug`, `name`) VALUES (@p1, @p2, @p3)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `role` SET `RoleID` = @p1, `slug` = @p2, `name` = @p3 WHERE ((`RoleID` = @" +
                "p4) AND ((@p5 = 1 AND `slug` IS NULL) OR (`slug` = @p6)) AND ((@p7 = 1 AND `name" +
                "` IS NULL) OR (`name` = @p8)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `RoleID`, `slug`, `name` FROM `role`";
        ...
        public virtual int Fill(animeDataSet1.roleDataTable dataTable) {
        ...
        public virtual animeDataSet1.roleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            animeDataSet1.roleDataTable dataTable = new animeDataSet1.roleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(animeDataSet1.roleDataTable dataTable) {
